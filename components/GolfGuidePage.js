    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.section}>
          ...
          <p>コンペの後には表彰式を予定しており、特別な賞品を多数ご用意致しております。（軽食は各自ご注文の上、ご精算くださいませ）</p>
          <p>ご多忙のところ誠に恐縮ではございますが、皆様奮ってご参加をお願い申し上げます。</p>
          <p style={{ textAlign: 'right', marginTop: '2rem' }}>敬具</p>
        ...
        <div className={styles.section}>
          ...
          <p><strong>開催日時：</strong> 2025年10月10日（金曜日）午前7時28分スタート（アウトコース）</p>
          <p><strong>開催場所：</strong> 那覇ゴルフ倶楽部</p>
          <p><strong>会場住所：</strong> 沖縄県島尻郡八重瀬町字富盛2270</p>
          <p>※プレー時間は4時間半を見込んでおります。（スループレー）</p>
          <p><strong>集合時間：</strong> 午前7時10分</p>
          <p><strong>集合場所：</strong> 那覇ゴルフ倶楽部スタートホール前</p>
          <p><strong>実施定員：</strong> 4組16名を予定しています</p>
        </div>
        ...
        <div className={styles.section}>
          ...
          <p><strong>会　　場：</strong> 那覇ゴルフ倶楽部コンペルーム</p>
        ...
        <div className={styles.section}>
          ...
          <p><strong>申し込み締切：</strong> 2025年8月30日</p>
          <p>先着順となりますので定員となり次第、回答日（30日）前に締め切らせていただくことがございます。ご了承のほどよろしくお願い申し上げます。</p>
          <p><strong>キャンセル期限：</strong> 2025年9月10日</p>
          <p>申込後にキャンセルされる場合も9月10日までに申し込みフォームよりご回答の変更手続きを行ってください。</p>
        </div>
